<div class="container d-flex flex-direction-row justify-content-center align-items-center">
    ...
    <div class="rounded-3 p-5 mt-4 w-50" style="background-color: var(--primary-color);">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control input-primary border border-0" id="exampleFormControlInput1" maxlength="11">
        </div>

        <div class="mb-3">
            <label for="inputPassword5" class="form-label title fw-semibold">Informe a SENHA</label>
            <input type="password" class="form-control input-primary border border-0" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" style="">
        </div>
