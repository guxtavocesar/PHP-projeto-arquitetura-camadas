...
<div class="container d-flex flex-direction-row justify-content-center align-items-center">
    ...
    <div class="rounded-3 p-5 mt-4 w-50" style="background-color: var(--primary-color); min-height: 60vh;">
        ...
        <div class="d-grid gap-4 mx-auto">
            ...
            <a href="<?php echo HOST ?>/cadastro" class="btn btn-primary button-primary-system fw-semibold btn-lg border border-0">
                Cadastrar
            </a>
        </div>
    </div>
