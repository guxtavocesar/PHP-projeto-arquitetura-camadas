...
if (isset($_POST['cpf'])) {
    ...
    if ($cpfFound == false) {
        ...
        $funcionario->setDataNascimento($_POST["Nascimento"]);
...
<div class="container d-flex flex-direction-row justify-content-center align-items-center">
    ...
    <div class="rounded-3 p-5 mt-4 w-50" style="background-color: var(--primary-color); height: 83vh;">
        ...
        <?php if(isset($cpfFound) && $cpfFound){ ?>

            <div class="alert alert-warning" role="alert">
                <span class="fw-medium">CPF já registrado! Tente efetuar o login novamente</span>
            </div>
        ...
        <div class="mb-3">
            <label for="Nascimento" class="form-label title fw-semibold">Informe seu nascimento</label>
            <input type="date" class="form-control input-primary border-0" id="Nascimento" name="Nascimento" maxlength="11" required>
        </div>

        <div class="mb-3">
            <label for="cpf" class="form-label title fw-semibold">Informe o CPF</label>
            <input type="text" class="form-control input-primary border-0" id="cpf" name="cpf" maxlength="11" required>
        </div>

        <div class="mb-3">
            <label for="senha" class="form-label title fw-semibold">Informe a senha</label>
            <input type="password" class="form-control input-primary border-0" id="senha" name="senha" class="form-control" aria-describedby="passwordHelpBlock" required>
        </div>
