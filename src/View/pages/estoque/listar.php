            ...
            <div class="detalhes-mesa justify-content-center rounded-4"
                ...
                <div class="d-flex flex-direction-row justify-content-between align-items-center">
                    ...
                    <table class="tabela w-100">
                        ...
                        ?>
                            <tr>
                                <th class="p-3" scope="row"><?php echo $produto->getId(); ?></th>
                                <td class="p-3"><?php echo $produto->getDescricao(); ?></td>
                                <td class="p-3"><?php echo $produto->getMarca(); ?></td>
                                <td class="p-3"><?php echo $produto->getFornecedor(); ?></td>
                                <td class="p-3"><?php echo $produto->getValorCusto(); ?></td>
                                <td class="p-3"><?php echo $produto->getValorVenda(); ?></td>
                                <td class="p-3"><?php echo $produto->getEstoqueAtual(); ?></td>
                                <td class="p-3"><?php echo $produto->getEstoqueMaximo(); ?></td>
                                
                                <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="<?php echo HOST ?>/estoque/editar/<?php echo $produto->getId() ?>" class="btn btn-warning">
