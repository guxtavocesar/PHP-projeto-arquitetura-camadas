                ...
                <div class="d-flex justify-content-center rounded-4">
                    <div class="rounded-3 p-5 mt-4 w-75" style="background-color: var(--primary-color); min-height: 60vh;">
                        <div class="d-flex flex-direction-row justify-content-center">
                            <h3 class="fs-2 mb-4 mx-2 logo-title">Editar estoque de ingrediente</h3>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control input-primary border-0" id="descricao" name="descricao" value="<?php echo $produto->getDescricao(); ?>" required>
                        </div>

                        <div class="mb-3 row">
                            <div class="col-6">
                                <label for="quantidadeAtual" class="form-label title fw-semibold">Quantidade Atual</label>
                                <input type="number" class="form-control input-primary border-0" id="quantidadeAtual" name="quantidadeAtual" value="<?php echo $produto->getEstoqueAtual(); ?>" required>
                            </div>

                            <div class="col-6">
                                <label for="quantidadeMaxima" class="form-label title fw-semibold">Quantidade Máxima</label>
                                <input type="number" class="form-control input-primary border-0" id="quantidadeMaxima" name="quantidadeMaxima" value="<?php echo $produto->getEstoqueMaximo(); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control input-primary border-0" id="valorCusto" name="valorCusto" value="<?php echo $produto->getValorCusto(); ?>" required>
                            </div>

                            <div class="col-6">
                                <label for="valorVenda" class="form-label title fw-semibold">Valor de venda</label>
                                <input type="text" class="form-control input-primary border-0" id="valorVenda" name="valorVenda" value="<?php echo $produto->getValorVenda(); ?>" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="marca" class="form-label title fw-semibold">Marca</label>
                            <input type="text" class="form-control input-primary border-0" id="marca" name="marca" value="<?php echo $produto->getMarca(); ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select input-primary border-0" id="fornecedor" name="fornecedor" required>
                                ...
                                <?php foreach($fornecedores as $fornecedor){ ?>
                                    <option value="<?php echo $fornecedor->getId(); ?>" <?php echo $produto->getIdFornecedor() == $fornecedor->getId() ? 'selected' : '' ?> ><?php echo $fornecedor->getNome(); ?></option>
                                <?php } ?>
                            </select> 
                        </div>
