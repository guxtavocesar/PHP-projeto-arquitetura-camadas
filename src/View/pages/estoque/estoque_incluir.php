                ...
                <div class="d-flex justify-content-center rounded-4">
                    <div class="rounded-3 p-5 mt-4 w-75" style="background-color: var(--primary-color); min-height: 60vh;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control input-primary border-0" id="descricao" name="descricao" required>
                        </div>

                        <div class="mb-3 row">
                            <div class="col-6">
                                <label for="quantidadeAtual" class="form-label title fw-semibold">Quantidade Atual</label>
                                <input type="number" class="form-control input-primary border-0" id="quantidadeAtual" name="quantidadeAtual" required>
                            </div>

                            <div class="col-6">
                                <label for="quantidadeMaxima" class="form-label title fw-semibold">Quantidade Máxima</label>
                                <input type="number" class="form-control input-primary border-0" id="quantidadeMaxima" name="quantidadeMaxima" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control input-primary border-0" id="valorCusto" name="valorCusto" required>
                            </div>

                            <div class="col-6">
                                <label for="valorVenda" class="form-label title fw-semibold">Valor de venda</label>
                                <input type="text" class="form-control input-primary border-0" id="valorVenda" name="valorVenda" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="marca" class="form-label title fw-semibold">Marca</label>
                            <input type="text" class="form-control   input-primary border-0" id="marca" name="marca" required>
                        </div>
